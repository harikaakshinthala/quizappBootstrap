...
submitBtn.addEventListener('click',()=>{
    ...
    console.log(currentQuizCount)
        ...
        if(currentQuizCount<quizData.length){
            ...
            //added a tool tip and color to the button and marquee tag
            quiz.innerHTML=(`<div style="background-image:url('https://i.ibb.co/frqqx3S/glitterimg.jpg')">
            <marquee><h2>You scored:${score}/${quizData.length}</h2> </marquee> 
               <button class="btn btn-primary" title="Restart quiz" onClick=location.reload()>Reload</button>
              </div> `)
